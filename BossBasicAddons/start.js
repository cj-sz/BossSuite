...
exports.initialize = (modPath) => {
    ...
    exports.onLoadGame = settings => {
        GetRootScope().showMessage("Houzi2004", "Hello and welcome to the Boss Suite. This modpack greatly increases the complexity of the base game. It is STRONGLY recommended to have no workstation cap and start with more money than usual. The Boss Basic Addons mod is a required install for others in the Boss Suite. Email houzi2004@gmail.com with any bug reports, suggestions, or comments. Don't forget to leave a review for any Boss Suite mods you are using on steam! Suite made by Houzi2004.");
